...
from .models import CATEGORY, Settings, DEPARTAMENTOS
...
class UserProfileForm(forms.Form):
    ...
    departamento_pertence = forms.ChoiceField(choices=DEPARTAMENTOS, label=_('Departamento:'))
    category = forms.BooleanField(label=_(u'Reserva Imediata (Marque se este usuário pode reservar sem permissão)'))
...
class LoginForm(UserProfileForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields.pop("departamento_pertence")
...
class UserForm(UserProfileForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if editing is None and instance is not None:
            ...
            self.fields["departamento_pertence"].initial = instance.departamento_pertence
    ...
    def set_fields(self, userprofile):
        ...
        userprofile.departamento_pertence = self.cleaned_data.get('departamento_pertence')
    ...
    def clean_registration_number(self):
        ...
        if (len(rn) is not 11):
            raise ValidationError([_('Registration Number must have 11 characters.'), ])
